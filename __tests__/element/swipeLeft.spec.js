...
it("defaults 'y' parameter to 0", async () => {
  ...
  expect(appiumService.findElement).toHaveBeenCalledTimes(1);
  expect(appiumService.swipeElement).toHaveBeenCalledTimes(1);
  expect(appiumService.swipeElement).toHaveBeenCalledWith(expect.objectContaining({ y: 0 }));
});
...
it("defaults 'x' parameter to the distance parameter", async () => {
  ...
  expect(appiumService.findElement).toHaveBeenCalledTimes(1);
  expect(appiumService.swipeElement).toHaveBeenCalledTimes(1);
  expect(appiumService.swipeElement).toHaveBeenCalledWith(expect.objectContaining({ x: distance, distance }));
});
...
it("defaults 'x' parameter to the percentage parameter", async () => {
  ...
  const distance = size.width * percentage;
